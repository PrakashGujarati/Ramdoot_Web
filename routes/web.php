...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('details_modal', [LogController::class,'getDetails'])->name('log.details_modal');
    Route::get('user_log/export/{start_date?}/{end_date?}/{user_id?}', [LogController::class,'userLogExport'])->name('user.log.export');
