                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="city" class="form-control city" id="city">
                                    @error('password')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="form-control-wrap">
                                    <input type="date" name="birth_date" class="form-control birth_date" id="birth_date">
                                    @error('birth_date')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div class="form-control-wrap">
                                    <input type="number" maxlength="10" name="mobile" class="form-control mobile" id="mobile">
                                    @error('mobile')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
