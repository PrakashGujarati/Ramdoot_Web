                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h4 class="nk-block-title">Login-In</h4>
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-lg block mt-1 w-full" id="email" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <div class="form-control-wrap">
                                            ...
                                            <input type="password" type="password" name="password" required  class="form-control form-control-lg" id="password" placeholder="Enter your password">
                                        <!-- </div> -->
