        ...
        <div class="col-lg-12">
            <div class="card h-100">
                <div class="card-inner">
                    <div class="card-head">
                        <h5 class="card-title">Add MCQ</h5>
                    </div>
                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-lg-3">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="opt1" name="opt1" value="{{ old('opt1') }}">
                                    @error('opt1')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="opt2" name="opt2" value="{{ old('opt2') }}">
                                    @error('opt2')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="opt3" name="opt3" value="{{ old('opt3') }}">
                                    @error('opt3')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="opt4" name="opt4" value="{{ old('opt4') }}">
                                    @error('opt4')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
