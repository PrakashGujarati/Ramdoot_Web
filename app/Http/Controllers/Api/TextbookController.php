	    	...
	    	if(count($getunit) > 0){
	    		...
	    		foreach ($getunit as $value) {
	    			...
	    			foreach ($getdata as $value1) {
                        ...
                        $url = env('APP_URL')."/upload/".$getdata->board_id."/".$getdata->medium_id."/".$getdata->standard_id."/".$getdata->semester_id."/".$getdata->subject_id."/".$getdata->unit_id."/"."book/url/".$value1->url;
	    				$thumbnail = env('APP_URL')."/upload/".$getdata->board_id."/".$getdata->medium_id."/".$getdata->standard_id."/".$getdata->semester_id."/".$getdata->subject_id."/".$getdata->unit_id."/"."book/thumbnail/".$value1->thumbnail;
